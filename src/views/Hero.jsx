  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.4} direction="down" padding fullWidth>
        <h5 className="mt-[90px] text-center text-lg leading-tight xs:text-xl text-white max-w-[500px]">
          {heroSubtitle}
        </h5>
      </FadeIn>
      <FadeIn delay={0.2} direction="up" padding fullWidth>
        <div className="relative w-full xs:w-[460px] mt-11">
          ...
          <img
            src={searchIcon}
            alt="searchIcon"
            className="absolute cursor-pointer top-2/4 -translate-y-2/4 right-3 h-11"
          />
        </div>
      </FadeIn>
