    ...
    >
      <FadeIn delay={0.2} direction="right">
        <div className="flex flex-col">
          <h1 className="text-5xl text-center 2xl:text-start text-fontBlack lg:text-[64px] font-medium mb-6">
            {productsTitle}
          </h1>
          <button className="flex items-center gap-2 px-4 py-2 mx-auto mb-10 font-bold transition-all ease-linear bg-transparent border border-transparent rounded-lg outline-none text-fontBlack w-fit hover:border-black focus:outline-none duration-350 2xl:mx-0 2xl:mb-0">
            ...
            <div className="h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
              ...
              <div className="absolute bottom-0 w-full bg-white h-[260px] rounded-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between">
                <div>
                  ...
                  <img src={starsIcon} alt="staricon" />
                </div>
                <div className="flex items-center justify-between">
                  <h3 className="text-2xl font-medium text-fontBlack lg:text-3xl">
                    {product.price}
                  </h3>
                  <img
                    src={plusIcon}
                    alt="plusicon"
                    className="w-10 h-10 cursor-pointer xs:h-12 xs:w-12"
                  />
                </div>
              </div>
            </div>
