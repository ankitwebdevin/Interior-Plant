        ...
        <div className="flex flex-col items-start gap-8">
          {careList.map((item, i) => (
            <FadeIn key={i} delay={(i + 1) * 0.2} direction="left">
              <div className="flex flex-col items-center gap-6 xs:flex-row xs:items-start">
                <img
                  src={item.img}
                  alt={item.title}
                ...
                <div>
                  ...
                  <h6 className="text-base font-medium text-center xs:text-start lg:text-lg text-fontGray">
                    {item.subtitle}
                  </h6>
                </div>
              </div>
